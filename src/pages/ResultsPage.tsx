...
import { AlertTriangle, CheckCircle2, ChevronLeft, Bug, ShieldCheck } from "lucide-react";
import type { Disease } from "@/lib/mockData";

const ResultsPage = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const disease = location.state?.disease as Disease | undefined;
    ...
    <div className="px-4 pt-4 pb-4">
      ...
      >
        <h2 className="font-bold text-base mb-3 flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-primary" /> Recommended Treatment
        </h2>
